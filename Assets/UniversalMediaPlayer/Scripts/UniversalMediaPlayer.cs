...
#pragma warning restore 0414
    ...
    [SerializeField]
    private string _desktopOutputFilePath;
    ...
    private void Awake()
    {
        ...
        switch (UMPSettings.SupportedPlatform)
        {
            ...
            case UMPSettings.Platforms.Linux:
                var standaloneOptions = new PlayerOptionsStandalone(new string[] { "--demux=h265" })
                {
            ...
            case UMPSettings.Platforms.Android:
                var androidOptions = new PlayerOptionsAndroid(new string[] { "--demux=h265" })
                {
                    FixedVideoSize = _useFixedSize ? new Vector2(_fixedVideoWidth, _fixedVideoHeight) : Vector2.zero,
